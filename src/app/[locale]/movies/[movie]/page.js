  ...
  return (
    <>
      ...
      <div className='w-1270 mx-auto flex flex-col sm:w-full sm:p-5'>
        ...
        <MovieSeances movie={filmDetail.data[0]} seancess={t('seancess')} title={`${filmDetail.data[0].filmName} ${t('tickets_showtimes')}`} subtitle={`${filmDetail.data[0].filmName} ${t('tickets_showtimes_subtext')}`} data={filmDetail.data[0].seances} />
      </div>
      <Footer />
    </>
  )
